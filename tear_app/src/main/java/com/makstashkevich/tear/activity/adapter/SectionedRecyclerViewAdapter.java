package com.makstashkevich.tear.activity.adapter;
...
import com.makstashkevich.tear.activity.adapter.Section.State;
...
//                Log.wtf("test", String.valueOf(sectionViewType));
